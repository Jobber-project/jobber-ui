...
const Button = React.forwardRef(({ variant = 'default', type = 'button', onClick, size = 'medium', className, outlined = false, disabled = false, fluid = false, loading = false, icon = null, spinnerColor, href, as, target, download, children, }, ref) => {
    ...
    const isLink = as === 'a';
    return (jsxRuntime.jsx("div", { children: jsxRuntime.jsxs(Component, Object.assign({ ref: ref, className: className, "$variant": variant, type: isLink ? undefined : type, onClick: onClick, "$size": size, "$outlined": outlined, disabled: disabled, icon: !!icon, fluid: fluid, "$loading": loading, href: isLink ? href : undefined, download: isLink ? download : undefined, as: as, target: isLink ? target : undefined }, { children: [!!icon && (jsxRuntime.jsx(IconWrapper$2, Object.assign({ "$outlined": outlined, "$variant": variant, "$size": size, fluid: fluid }, { children: icon }), `${variant}-icon-wrapper`)), jsxRuntime.jsx(ChildrenWrapper, Object.assign({ "$outlined": outlined, "$variant": variant, "$size": size, "$loading": loading }, { children: children }), `${variant}-children-wrapper`), loading && (jsxRuntime.jsx(InnerWrapper, { children: jsxRuntime.jsx(StyledSpinner, { "$variant": variant, "$outlined": outlined, "$spinnerColor": spinnerColor, size: "small" }, void 0) }, void 0))] }), void 0) }, void 0));
});
...
const Checkbox = ({ required, disabled = false, defaultChecked, checked, flipped = false, value, variant = 'default', id, name, className, label, onChange, }, ref) => {
    ...
    return (jsxRuntime.jsxs(Container$6, Object.assign({ "$disabled": disabled, "$flipped": flipped, className: className, as: label ? undefined : 'span' }, (label ? { htmlFor: derivedId } : {}), { children: [jsxRuntime.jsxs(Square, { children: [jsxRuntime.jsx(Input$2, { ref: ref, "$disabled": disabled, "$variant": variant, required: required, disabled: disabled, defaultChecked: derivedDefaultChecked, checked: derivedChecked, value: value, type: "checkbox", id: derivedId, name: name, onChange: onChange }, void 0), jsxRuntime.jsx(SquareBorder, { "$disabled": disabled, "$variant": variant }, void 0), jsxRuntime.jsx(Svg, Object.assign({ width: "13", height: "10", viewBox: "0 0 13 10", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, { children: jsxRuntime.jsx(Checkmark, { "$disabled": disabled, "$variant": variant, d: "M1.3335 4.99996L4.66683 8.33329L11.3335 1.66663", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, void 0) }), void 0)] }, void 0), !!label && (jsxRuntime.jsx(Text$2, Object.assign({ "$disabled": disabled, "$flipped": flipped, "$variant": variant }, { children: label }), void 0))] }), void 0));
};
...
const getIcon$1 = (icon) => {
    switch (icon) {
        case 'camera':
        default:
            return jsxRuntime.jsx(SvgCamera, { height: "16px", width: "16", viewBox: "0 0 24 24" }, void 0);
    }
};
...
const Icon = ({ icon, onClick, size }) => {
    return (jsxRuntime.jsx(ButtonWrapper, Object.assign({ onClick: onClick }, { children: jsxRuntime.jsx(IconWrapper, Object.assign({ size: size }, { children: getIcon$1(icon) }), void 0) }), void 0));
};
const Avatar = ({ src, name = 'N N', id, size, className, disabled = false, onClick, icon, }) => {
    const initials = name
        ...
        .map(n => n[0])
        .join('');
    return (jsxRuntime.jsxs(AvatarWrapper, { children: [jsxRuntime.jsx(Circle, Object.assign({ size: size, id: id, className: className, "$disabled": disabled }, { children: src ? (jsxRuntime.jsx(Image, { src: src, alt: 'Avatar' }, void 0)) : (jsxRuntime.jsx(Text, Object.assign({ "$disabled": disabled, id: id, size: size }, { children: initials }), void 0)) }), void 0), icon && size === 'large' && (jsxRuntime.jsx(Icon, { size: size, onClick: onClick, icon: icon }, void 0))] }, void 0));
};
...
const Slider = ({ disabled, onChange, min = 0, max = 100, step = 1, defaultValue, }) => {
    return (jsxRuntime.jsx(SliderWrapper, { children: jsxRuntime.jsx(RCSlider__default["default"], { min: min, max: max, step: step, disabled: disabled, onChange: onChange, defaultValue: defaultValue !== null && defaultValue !== void 0 ? defaultValue : min }, void 0) }, void 0));
};
...
const Menu = ({ className, isVisible, align = 'left', children }, ref) => {
    ...
    return (jsxRuntime.jsx(MenuContainer, Object.assign({ className: className, isVisible: isVisible }, { children: jsxRuntime.jsx(MenuWrapper, Object.assign({ ref: ref, "$align": align }, { children: getMutableChildrenArray().reduce((acc, child, i) => {
                if (child) {
...
function getIcon(variant) {
    switch (variant) {
        case 'info':
            return jsxRuntime.jsx(SvgInfoCircleFilled, { width: 32, height: 32, viewBox: "0 0 24 24" }, void 0);
        case 'success':
            return jsxRuntime.jsx(SvgCircleCheckFilled, { width: 32, height: 32, viewBox: "0 0 24 24" }, void 0);
        case 'warning':
            return jsxRuntime.jsx(SvgAlertTriangleFilled, { width: 32, height: 32, viewBox: "0 0 24 24" }, void 0);
        case 'error':
            return jsxRuntime.jsx(SvgAlertCircleFilled, { width: 32, height: 32, viewBox: "0 0 24 24" }, void 0);
        default:
            return null;
    }
}
...
const ProgressBar = React.memo(({ duration, color, onAnimationEnd }) => {
    return (jsxRuntime.jsx(ProgressWrapper, { children: jsxRuntime.jsx(Progress, { "$duration": duration, "$color": color, onAnimationEnd: onAnimationEnd }, void 0) }, void 0));
});
...
const Toast = ({ duration = 5000, id, variant = 'info', title, message, onClick, }) => {
    ...
    return (jsxRuntime.jsxs(Container$2, Object.assign({ onClick: handleClick }, { children: [jsxRuntime.jsxs(Inner, { children: [jsxRuntime.jsx(InnerLeft, Object.assign({ "$color": color }, { children: icon }), void 0), jsxRuntime.jsxs(InnerRight, { children: [!!title && jsxRuntime.jsx(Title, Object.assign({ "$color": color }, { children: title }), void 0), !!message && jsxRuntime.jsx(Message, { children: message }, void 0)] }, void 0)] }, void 0), jsxRuntime.jsx(ProgressBar, { duration: duration, color: color, onAnimationEnd: handleAnimationEnd }, void 0), jsxRuntime.jsx(CloseButton, Object.assign({ type: "button", onClick: handleCloseClick, "aria-label": "close" }, { children: jsxRuntime.jsx(SvgX, { width: 20, height: 20, viewBox: "0 0 24 24" }, void 0) }), void 0)] }), void 0));
};
// @ts-ignore
...
const Toaster = () => {
    ...
    return reactDom.createPortal(jsxRuntime.jsx(ToasterContext.Provider, Object.assign({ value: value }, { children: toasts.map((_a, index) => {
            var { closing, bottom = 10, left = 10, onTransitionEnd } = _a, props = __rest(_a, ["closing", "bottom", "left", "onTransitionEnd"]);
            return (jsxRuntime.jsx(Positioner, Object.assign({ "$closing": closing, "$index": index, "$bottom": bottom, "$left": left, onTransitionEnd: onTransitionEnd }, { children: jsxRuntime.jsx(MemoizedToast, Object.assign({}, props), void 0) }), props.id));
