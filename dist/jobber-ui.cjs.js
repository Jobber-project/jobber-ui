...
const Menu = ({ className, isVisible, children }) => {
    return (jsxRuntime.jsx(MenuContainer, Object.assign({ className: className, isVisible: isVisible }, { children: jsxRuntime.jsx(MenuWrapper, { children: children }, void 0) }), void 0));
};
Menu.Item = Item;
