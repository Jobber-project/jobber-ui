...
const TextField = ({ required, disabled, variant = 'default', id, name, type = 'text', className, size = 'medium', label, value, placeholder, helperText, iconAlign, icon, onChange, }) => {
    ...
    function getDerivedIcon() {
        switch (variant) {
            case 'success':
                return jsxRuntime.jsx(img$4, { viewBox: "0 0 24 24" }, void 0);
            case 'warning':
                return jsxRuntime.jsx(img$3, { viewBox: "0 0 24 24" }, void 0);
            case 'error':
                return jsxRuntime.jsx(img$2, { viewBox: "0 0 24 24" }, void 0);
            case 'default':
            default: {
                if (icon)
                    return icon;
                if (type === 'email')
                    return jsxRuntime.jsx(img$1, { viewBox: "0 0 24 24" }, void 0);
                if (type === 'search')
                    return jsxRuntime.jsx(img, { viewBox: "0 0 24 24" }, void 0);
                return undefined;
            }
        }
    }
