...
const Spinner = ({ size = 'medium', color = COLORS.emerald, className, children, }) => {
    ...
    return (React__default.createElement(Container$e, { className: className },
...
const Button = forwardRef$1(({ variant = 'default', type = 'button', onClick, size = 'medium', className, outlined = false, disabled = false, fluid = false, loading = false, icon = null, spinnerColor, href, as, target, download, children, }, ref) => {
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(Component, Object.assign({ "$disabled": disabled, ref: ref, className: className, "$variant": variant, onClick: onClick, "$size": size, "$outlined": outlined, disabled: disabled, icon: !!icon, fluid: fluid, "$loading": loading, as: as }, (isLink
            ? {
                href,
                download,
                target,
            ...
            !!icon && (React__default.createElement(IconWrapper$3, { "$disabled": disabled, "$outlined": outlined, "$variant": variant, "$size": size, key: `${variant}-icon-wrapper`, fluid: fluid }, icon)),
            React__default.createElement(ChildrenWrapper, { "$disabled": disabled, "$outlined": outlined, "$variant": variant, "$size": size, key: `${variant}-children-wrapper`, "$loading": loading }, children),
            loading && (React__default.createElement(InnerWrapper, null,
                React__default.createElement(StyledSpinner, { "$disabled": disabled, "$variant": variant, "$outlined": outlined, "$spinnerColor": spinnerColor, size: "small" }))))));
});
...
const Container$d = styled.label `
  display: inline-flex;
...
const Checkbox = ({ required, disabled = false, defaultChecked, checked, flipped = false, value, variant = 'default', id, name, className, label, onChange, }, ref) => {
    ...
    return (React__default.createElement(Container$d, Object.assign({ "$disabled": disabled, "$flipped": flipped, className: className, as: label ? undefined : 'span' }, (label ? { htmlFor: derivedId } : {})),
...
const Container$c = styled.label `
  display: inline-flex;
  align-items: center;
  cursor: ${props => (props.$disabled ? 'default' : 'pointer')};
`;
...
const RadioButton = ({ required, disabled = false, defaultChecked, checked, variant = 'default', id, name, label, value, className, onChange, }, ref) => {
    ...
    const derivedId = getDerivedId();
    return (React__default.createElement(Container$c, Object.assign({ "$disabled": disabled, className: className, as: label ? undefined : 'span' }, (label ? { htmlFor: derivedId } : {})),
...
`;
const animateHelperText$3 = keyframes `
  0% {
    opacity: 0;
  }
...
`;
const HelperText$3 = styled.span `
  display: block;
  padding-top: 5px;
  font-size: 10px;
  line-height: 1.172em;
...
const TextField = ({ required, disabled, autoFocus, variant = 'default', id, name, type = 'text', className, size = 'medium', label, value, placeholder, helperText, ariaLabel, iconAlign = 'left', icon, onChange, }, ref) => {
    ...
    return (React__default.createElement(Container$b, { "$variant": variant, "$disabled": disabled, "$size": size, className: className },
        !!label && React__default.createElement(Label$3, { htmlFor: derivedId }, label),
        ...
        !!helperText && (React__default.createElement(HelperText$3, { "$animate": shouldAnimate, "$variant": variant, onAnimationEnd: handleAnimationEnd }, helperText))));
};
...
const Horizontal = ({ className, onLeftButtonClick, onRightButtonClick, }) => {
    return (React__default.createElement(Container$a, { className: className },
...
const Vertical = ({ className, onTopButtonClick, onBottomButtonClick, }) => {
    return (React__default.createElement(Container$a, { "$vertical": true, className: className },
...
var Handle = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var handleNode = /*#__PURE__*/React.createElement("div", _extends$6({
    ref: ref,
...
var Handles = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, values.map(function (value, index) {
    return /*#__PURE__*/React.createElement(Handle, _extends$6({
...
const Toast = ({ duration = 5000, id, variant = 'info', title, message, onClick, }) => {
    ...
    return (React__default.createElement(Container$9, { onClick: handleClick },
        React__default.createElement(Inner, null,
            ...
            React__default.createElement(InnerRight, null,
                !!title && React__default.createElement(Title$2, { "$color": color }, title),
                !!message && React__default.createElement(Message$1, null, message))),
...
const Select = ({ disabled, className, variant = 'default', id, placeholder = '', name, value = '', options, onChange, }, ref) => {
    ...
    const derivedId = getDerivedId();
    return (React__default.createElement(Container$8, { "$disabled": disabled, "$variant": variant, className: className },
...
const TextArea = ({ required, disabled, autoFocus, rows, className, resizable = false, variant = 'default', id, name, label, helperText, value, placeholder, ariaLabel, onChange, question, }, ref) => {
    ...
    const derivedId = getDerivedId();
    return (React__default.createElement(Container$7, { className: className },
        ...
        question && !disabled && (React__default.createElement(Tooltip, { label: question, position: "left" },
            React__default.createElement(QuestionMarkContainer, null,
                React__default.createElement(SvgQuestionMark, { width: 16, height: 16, color: COLORS.white, viewBox: "0 0 24 24" }))))));
};
...
const CustomSelect = (props, ref) => {
    // @ts-ignore
    return React__default.createElement(Select$1, Object.assign({ ref: ref }, props));
};
const ForwardedRefCustomSelect = forwardRef$1(CustomSelect);
...
function CustomControl(props) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        !!helperText && !menuIsOpen && (React__default.createElement(HelperText$1, { animate: animate, variant: variant, onAnimationEnd: onAnimationEnd }, helperText))));
}
...
function MultiSelect(_a) {
    ...
    const derivedId = getDerivedId();
    const derivedIcon = getDerivedIcon();
    return (React__default.createElement(Container$6, { className: className },
...
function Hero({ className, title, subtitle, children }) {
    return (React__default.createElement(Container$5, { className: className },
        (!!title || !!subtitle) && (React__default.createElement(Header, null,
            !!title && React__default.createElement(Title$1, null, title),
...
function Label({ className, variant = 'default', as, htmlFor, children, }) {
    return (React__default.createElement(Container$4, { "$variant": variant, as: as, htmlFor: as ? undefined : htmlFor, className: className }, children));
}
...
function HelperText({ className, variant = 'default', children, }) {
    ...
    return (React__default.createElement(Container$3, { ref: ref, "$animate": shouldAnimate, "$variant": variant, className: className }, children));
}
...
function PlainButtonComponent(_a, ref) {
    ...
    return React__default.createElement(Container$2, Object.assign({ ref: ref, type: type }, buttonProps));
}
const PlainButton = forwardRef$1(PlainButtonComponent);
...
function ModalComponent({ unmountOnClose = false, id = '', className, children, onDidClose, }, ref) {
    ...
    return shouldRender()
        ? createPortal(React__default.createElement(Wrapper, { "$visible": visible, "$hidden": !visible && !closing },
            React__default.createElement(Backdrop, { ref: backdropRef, "$closing": closing, onClick: visible && !closing ? () => setClosing(true) : undefined }),
            React__default.createElement(Container$1, { ref: containerRef, "$closing": closing, className: className, "aria-modal": "true", role: "dialog" }, children)), portalRef.current, id)
        : null;
}
const Modal = forwardRef$1(ModalComponent);
...
function DialogComponent({ title, message, buttons, onDidClose }, forwardedRef) {
    ...
    return (React__default.createElement(DialogModal, { ref: ref, unmountOnClose: true, onDidClose: onDidClose },
        React__default.createElement(Container, null,
            React__default.createElement(TopBar, null,
                React__default.createElement(PlainButton, { onClick: () => close(), "aria-label": "close" },
                    React__default.createElement(SvgX, { width: 20, height: 20, viewBox: "0 0 24 24" }))),
            !!title && React__default.createElement(Title, null, title),
            !!title && !!message && React__default.createElement(HorizontalLine, null),
            !!message && React__default.createElement(Message, null, message),
            !!(buttons === null || buttons === void 0 ? void 0 : buttons.length) && (React__default.createElement(ButtonsRow, null, buttons.map(({ loading, outlined, variant, title, onClick }) => (React__default.createElement(ButtonCol, { key: title },
                React__default.createElement(Button, { loading: loading, outlined: outlined, variant: variant, onClick: onClick }, title)))))))));
}
...
const Dialog = forwardRef$1(DialogComponent);

function DialogProvider() {
    const { ref, open, close } = useModal();
    const [config, setConfig] = useState(null);
    const didClickButton = useRef(false);
    useEffect(() => {
    ...
    return config ? (React__default.createElement(Dialog, { ref: ref, title: config.title, message: config.message, buttons: config.buttons, onDidClose: config.onDidClose })) : null;
}

function useDialog() {
    const confirm = useCallback((args) => __awaiter(this, void 0, void 0, function* () {
        const result = yield Dialog.confirm(args);
        return result;
    }), []);
    const info = useCallback((args) => __awaiter(this, void 0, void 0, function* () {
...
export { Avatar, Button, ForwardedCheckbox as Checkbox, DialogProvider, GlobalStyle, HelperText, Hero, Label, ForwardedMenu as Menu, Modal, MultiSelect, PlainButton, ForwardedRadioButton as RadioButton, ForwardedSelect as Select, Slider, Spinner, Switcher, Text, ForwardedTextArea as TextArea, ForwardedTextField as TextField, MemoizedToast as Toast, Toaster, Tooltip, globalStyle, useDialog, useModal };
